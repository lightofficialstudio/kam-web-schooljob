...
// ✨ Signin Form — Minimal + Modern + smooth animation + dark mode
import { ModalComponent } from "@/app/components/modal/modal.component";
import { useAuthStore } from "@/app/stores/auth-store";
import { LockOutlined, MailOutlined } from "@ant-design/icons";
import { Button, Col, Divider, Flex, Form, Input, Typography, theme as antTheme } from "antd";
...
export const SigninForm = () => {
  // ✨ ดึง token จาก global theme — ไม่ hardcode hex
  ...
  return (
    <>
      ...
      {/* ✨ keyframes อยู่ใน globals.css — ไม่มี inline style */}
      <Col xs={24} md={14}>
        <Flex
          vertical
          justify="center"
        ...
        >
          ...
          >
            ...
            {/* ✨ Submit — hover effect ผ่าน CSS class ใน globals.css */}
              ...
              <Form.Item style={{ marginBottom: 0 }}>
                <Button
                  ...
                  style={{
                    ...
                    fontWeight: 700,
                    fontSize: 15,
                    boxShadow: `0 8px 24px ${token.colorPrimary}45`,
                    letterSpacing: "0.3px",
                  }}
                >
