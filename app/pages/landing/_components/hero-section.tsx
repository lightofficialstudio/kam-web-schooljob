              ...
              <Col xs={24} sm={12} lg={7}>
                <div className="flex flex-col gap-3 items-start">
                  ...
                  <Cascader
                    ...
                    classNames={{ placeholder: "text-left" }}
                    styles={{ placeholder: { lineHeight: "64px" } }}
                    size="large"
                    showCheckedStrategy={Cascader.SHOW_CHILD}
                    prefix={<Briefcase size={18} className="text-[#437FC7]" />}
                    suffixIcon={
              ...
              <Col xs={24} sm={12} lg={7}>
                <div className="flex flex-col gap-3 items-start">
                  ...
                  <Cascader
                    ...
                    expandTrigger="hover"
                    prefix={<MapPin size={18} className="text-[#437FC7]" />}
                    suffixIcon={
                      <ChevronDown size={16} className="text-gray-400" />
                    }
                  />
