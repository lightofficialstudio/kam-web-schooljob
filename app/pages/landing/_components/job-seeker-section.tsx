...
import { Briefcase, Search, Sparkles, Zap } from "lucide-react";
            ...
            <div className="space-y-8 text-left">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-bold text-emerald-500 uppercase">
                  เปิดรับใบสมัครแล้ววันนี้
                </span>
              </div>

              <h3
                className={`text-4xl md:text-6xl font-black leading-tight tracking-tight ${titleColorClass}`}
              >
              ...
              <p
                className={`text-lg md:text-xl font-medium opacity-80 leading-relaxed ${textColorClass}`}
              >
                สร้างโปรไฟล์ของคุณให้โดดเด่น
                และก้าวเข้าสู่รั้วโรงเรียนที่คุณปรารถนา
                ร่วมเป็นส่วนหนึ่งของสังคมครูยุคใหม่ได้ฟรี
                พร้อมระบบคัดกรองที่รวดเร็ว
              </p>
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    <div className={`text-sm font-black ${titleColorClass}`}>
                      พร้อมเริ่มงานทันที
                    </div>
                  </div>
                </motion.div>
